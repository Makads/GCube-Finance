...
class ViewCartController extends ViewBaseController
{
    ...
    protected function viewCartFun($request, $cart, $param)
    {
        ...
        if ($request->isPost() && $param["statuscart"] == "removepromo") {
            ...
            if ($request->isPost() && $param["statuscart"] == "promo") {
                ...
                if ($request->isPost() && $param["statuscart"] == "checkout") {
                    if (!$param["terms"]) {
        ...
        if (is_profession()) {
            ...
            foreach ($setConfig["option"] as $setConfigOption) {
                ...
                if ($setConfigOption["option_type"] == 5) {
                    ...
                    if ($setConfigOption["option_type"] == 12) {
