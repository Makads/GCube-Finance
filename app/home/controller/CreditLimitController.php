...
class CreditLimitController extends \cmf\controller\HomeBaseController
{
    ...
    public function creditLimitPrepayment()
    {
        ...
        $data = ["uid" => $uid, "create_time" => time(), "due_time" => time(), "subtotal" => $amount, "total" => $amount, "status" => "Unpaid", "payment" => $clients["defaultgateway"], "type" => "credit_limit", "notes" => "信用额提前还款", "url" => "credit", "credit_limit_prepayment" => 1, "credit_limit_prepayment_invoices" => json_encode($invoices)];
