...
class LoginController extends \cmf\controller\HomeBaseController
{
    ...
    public function login()
    {
        ...
        if ($comparePasswordResult) {
            ...
            if (empty($param["phone_code"]) && $client["second_verify"] == 1 && !empty($second_verify_home) && !empty($second_verify_login) && empty($verification_success_1) && empty($verification_success_2)) {
